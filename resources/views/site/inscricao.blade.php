            ...
            <div class="card wizard-card ct-wizard-orange" id="wizardProfile">
                <ul class="groups-steps">
                    ...
                    @foreach ($perfis as $perfil)
                        ...
                        @endif
                    @endforeach
                    <li class="confirmation-step fixed-step">
                        <a href="#confirmacao-step" data-toggle="tab">Confirmação</a>
                    </li>
                </ul>

                <div class="tab-content">
                    <div class="tab-pane" id="confirmacao-step">
                    ...
                    @else
                    <input  name="campo-perfil" type="hidden"
                            value="@if (isset($perfil[0])) {{ $perfil[0]->id }} @else {{ $perfil->id }} @endif"
                    >
                    @endif
