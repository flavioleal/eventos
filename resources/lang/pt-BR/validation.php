...
return [
    ...
    */
    ...
    'attributes' => [
        'cod_job'           => 'Código do JOB',
        'data_inclusao'     => 'Data de inclusão',
        'data_expiracao'    => 'Data de expiração',
        'profissao'         => 'Profissão ou Atuação',
        'cargo'             => 'Cargo',
        'localidade'        => 'Localidade',
        'faixa_etarias_id'  => 'Faixa etária',
        'faixa_salarials_id'=> 'Faixa salarial',
        ...
        'empresa'           => 'Empresa',
        'telefone'          => 'Telefone',
        'password_confirmation' => 'Confirmação de Sennha',
        'profissional_areas'=> 'Áreas',
        'password'=> 'Senha'
    ],
