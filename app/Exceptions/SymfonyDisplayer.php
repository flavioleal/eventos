...
class SymfonyDisplayer
{
    ...
    public function getContent(FlattenException $exception)
    {
        switch ($exception->getStatusCode()) {
            case 404:
                $title = 'Desculpe, a página que você está procurando não pôde ser encontrado.';
                break;
            default:
...
EOF;
	...
	<body>
		<div class="container">
			<div class="content">
				<div class="title">Desculpe, a página que você está procurando não pôde ser encontrada.</div>
			</div>
		</div>

		<img src="/img/compumake-logo.png" style="position: absolute; bottom: 20px; right: 20px; width: 120px;"/>
	</body>
</html>
EOF;
        }
...
<html>
    ...
    <body>
        $content
        <img src="/img/compumake-logo.png" style="position: fixed; bottom: 20px; right: 20px; width: 120px;"/>
    </body>
</html>
EOF;
    }
