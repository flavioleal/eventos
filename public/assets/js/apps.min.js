...
var handleSlimScroll = function() {
    ...
    App = function() {
        ...
        return {
            init: function() {
                handleDraggablePanel(), handleLocalStorage(), handleResetLocalStorage(), handleSlimScroll(),
                handleSidebarMenu(), handleMobileSidebarToggle(), handleSidebarMinify(), handleMobileSidebar(),
                handleThemePageStructureControl(), handleThemePanelExpand(), handleAfterPageLoadAddClass(),
                handlePanelAction(), handelTooltipPopoverActivation(), handleScrollToTopButton(),
                handlePageContentView(), handleIEFullHeightContent(), handleUnlimitedTabsRender()
            }
        }
    }();