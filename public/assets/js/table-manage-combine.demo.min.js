...
var handleDataTableCombinationSetting = function() {
    ...
    if ($("#data-table").length !== 0) {
        if ($(window).width() >= 767) {
            ...
            new $.fn.dataTable.KeyTable(e);
            new $.fn.dataTable.AutoFill(e, {
                mode: "both",
                complete: function(e) {
                    var t = e[e.length - 1];
                    $.gritter.add({
                        title: 'Table Column Updated <i class="fa fa-check-circle text-success m-l-3"></i>',
                        text: e.length + ' cells were altered in this auto-fill. The value of the last cell altered was: <span class="text-white">' + t.oldValue + '</span> and is now <span class="text-white">' + t.newValue + "</span>",
                        sticky: true,
                        time: "",
