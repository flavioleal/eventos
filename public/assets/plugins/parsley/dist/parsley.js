    ...
    _insertErrorWrapper: function (fieldInstance) {
      ...
      if ('string' === typeof fieldInstance.options.errorsContainer )
        if ($(fieldInstance.options.errorsContainer + '').length)
          return $(fieldInstance.options.errorsContainer).closest('.form-group').append(fieldInstance._ui.$errorsWrapper);
      ...
      return 'undefined' === typeof fieldInstance.options.multiple ? fieldInstance.$element.closest('.form-group').append(fieldInstance._ui.$errorsWrapper) : fieldInstance.$element.closest('.form-group').append(fieldInstance._ui.$errorsWrapper);
    },
